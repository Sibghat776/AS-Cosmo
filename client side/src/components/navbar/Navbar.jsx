  ...
  return (
    <>
      <div className='navbar' style={{
        ...
        <img src="/img/menuBar.png" height="30px" width="30px" onClick={() => {
              ...
              <div className={`toggleOptions ${toggleOptions ? 'active' : ''}`}>
                {userData?.isAdmin ? (
                  <div>
                    ...
                    <Link to='/addProduct' onClick={() => {
                      handleOptionClick('/addProduct')
                      setIsToggle(false)
                      setToggleOptions(false)
                    }}>
                      <li>add product</li>
                ...
                {userData?.isAdmin ? (
                  <Link to='/notifications' onClick={() => {
                    handleOptionClick('/notifications')
                    setIsToggle(false)
                    setToggleOptions(false)
                  }}>
                    <li>notifications</li>
