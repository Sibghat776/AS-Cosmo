...
export const login = async (req, res, next) => {
    try {
        ...
        // if (user.email !== req.body.email) return next(createError(400, "Wrong Credentials")); // NOTE: This line is redundant since findOne already checks the email
        ...
        res.cookie("access_token", token, {
            httpOnly: true,
            secure: true,
            // Ager aap development mein hain aur HTTPS nahi use kar rahay to `secure: false` karain.
